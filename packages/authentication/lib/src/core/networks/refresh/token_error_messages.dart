...
class TokenErrorMessages {
  ...
  static const String failedToGetPublicToken = 'Failed to get public token';

  static String failedToSavePublicToken = 'Failed to save public token';

  static String failedToClearPublicToken = 'Failed to clear public token';
}
